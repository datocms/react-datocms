...
describe("Image", () => {
  ...
  describe("not visible", () => {
    it("renders the blur-up thumb", () => {
      const wrapper = mount(<Image data={data} intersectionThreshold={0.1} />);
  ...
  describe("visible", () => {
    it("renders the image", () => {
      const wrapper = mount(<Image data={data} intersectionThreshold={0.2} />);
    ...
    describe("image loaded", () => {
      it("shows the image", () => {
        const wrapper = mount(<Image data={data} intersectionThreshold={0.3} />);
        mockAllIsIntersecting(true);
        wrapper.update();
