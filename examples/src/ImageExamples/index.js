...
export default function ImageExamples() {
  ...
  return (
    <>
      ...
      >
        <Image data={data} ref={ref} />
      </div>

      <div
        className="example"
        data-title="Image with transparency, custom fade-in duration"
      >
        <Image data={dataWithAlpha} fadeInDuration={10000} />
      </div>
      ...
      >
        <Image data={data} layout="responsive" />
      </div>
      ...
      >
        ...
        >
          <Image data={data} layout="fill" objectFit="cover" />
          <div
            style={{
              position: "absolute",
              inset: 0,
